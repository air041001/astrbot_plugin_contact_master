...
> 🖼️ **[图片占位：放一张修复前大模型说“我看不到内容” VS 修复后大模型准确复述发信内容的对比截图]**

### 2. 📇 说人话，别背 UMO (自然语言联系人)
...
> 🖼️ **[图片占位：放一张你让大模型“把某人添加到通讯录”，然后“给小王发消息”的聊天截图]**
...
**最后：**
写这个 v5.0.0 踩了不少坑，如果它刚好也解决了你遇到的上下文断层问题，欢迎点个 Star！有 Bug 随时提 Issue！
