...
2.**contact_master,send_message_to_user工具硬指令触发**:不论是我的还是官方的都是由自然语言触发，有时很容易受bot人设影响而无法使用，后续考虑增加新的硬指令强制触发
---

**最后：**
写这个 v5.0.0 踩了不少坑，如果它刚好也解决了你遇到的上下文断层问题，欢迎点个 Star！有 Bug 随时提 Issue！但其实我还有很多场景没有测试，如有问题随时提issue。
你要问能直接发消息的前提下搞间接发送有什么意义？可能只是一些话从会突然从bot口中说出来的一种小惊喜或仪式感吧
---
